 ...
 * 
 * It still does not work correctly like in the 2.7 inches small epaper
 */
#include <stdio.h>
...
uint8_t cursor_y_offset = 20; 
uint8_t cursor_space = 4; 
uint16_t t_counter = 0;
uint16_t cursor_y_line_height = 12;
